...
var DocumentController = {
    index: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, document_1.Document.find()];
                case 1:
                    documents = _a.sent();
                    res.send(documents);
                    return [2 /*return*/];
    ...
    show: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.params.id;
                    return [4 /*yield*/, document_1.Document.findById(id)];
                case 1:
                    document = _a.sent();
                    res.send(document);
                    return [2 /*return*/];
    ...
    store: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            document.save(function (err) {
                if (err)
                    return Error("Could not store document.");
                res.send(document);
            });
            return [2 /*return*/];
        });
    ...
    update: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var id, _a, title, content, document;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    id = req.params.id;
    ...
    destroy: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            id = req.params.id;
            document_1.Document.findByIdAndDelete(id, null, function (err, doc) {
                if (err)
